...
export default async function SettingsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-xl lg:text-2xl font-bold text-zinc-100">Settings</h1>
        <p className="text-sm text-zinc-400">Manage your organization settings</p>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          {/* Categories - Admin can edit */}
          {isAdmin ? (
            <CategoryManager
              categories={organization.categories.map((c) => ({
                id: c.id,
                name: c.name,
            ...
            <Card className="bg-zinc-900 border-zinc-800">
              <CardHeader>
                ...
                <CardDescription className="text-zinc-500">
                  Costume categories for organizing inventory
                </CardDescription>
              </CardHeader>
              <CardContent>
                {organization.categories.length > 0 ? (
                  ...
                  <p className="text-zinc-500 text-sm">No categories created yet</p>
                )}
              </CardContent>
            </Card>
          )}
        ...
        {isAdmin && (
          <RentalAgreementEditor initialText={organization.rentalAgreementText} />
        )}
